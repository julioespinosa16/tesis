...
coordCuadr<- function(ex, yi){
  ...
  pow_x<-match(TRUE, round(1/dim2, 1:20) == 1/dim2)
  pow_y<-match(TRUE, round(1/dim1, 1:20) == 1/dim1)
  ...
  extrTot<- list(supIzq=  c(equisCu,yeCu),supDer= c(equisCu+1/dim2,yeCu), infIzq= c(equisCu,yeCu-1/dim1), 
                 infDer=c(equisCu+1/dim2,yeCu-1/dim1) )
